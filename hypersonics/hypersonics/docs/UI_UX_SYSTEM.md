...
Have one button called "Run REGEN-TWIN Mission". It should trigger live telemetry, changing heat map, animated cooling, charts, and an AI recommendation update.
