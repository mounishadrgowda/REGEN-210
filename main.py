...
app = FastAPI(
    title="AETHER-TWIN Hypersonic Digital Twin API",
    version="0.1.0",
    description="Hackathon-ready digital twin APIs for hypersonic TPS simulation.",
)
...
async def health() -> dict[str, str]:
    return {"status": "nominal", "system": "AETHER-TWIN"}
